   ...
   <div class="d-flex">
    <div class="col-9 align-self-center">
        <div class="d-flex flex-column card card-body p-3 px-5 mb-5 shadow-lg">
            ...
            The results of COP 26 signal a shift from negotiations and target setting to action implementation and a further increase in ambition. Countries must present more ambitious short- and long-term climate action plans to reduce greenhouse gas emissions and improve their resilience.  
            </div>
        </div>
    </div>
    <div class="col-3 ">
