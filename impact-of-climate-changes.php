        ...
        <div class="d-flex flex-column card card-body p-3 px-5 mb-5 shadow-lg">
            ...
            <div class="card shadow-lg">
                <div class="card-body p-3 px-4">
                    <h4 class="card-title mb-4 pb-3">Natural Health Social Business</h4>
                    <div class="d-flex">
                        <div class="col-3 pl-0 pr-2 mr-2">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <a class="nav-link mb-2 active" id="v-pills-first-tab" data-bs-toggle="pill" href="#v-pills-first" role="tab" aria-controls="v-pills-first" aria-selected="true">Hotter temperatures  </a>
